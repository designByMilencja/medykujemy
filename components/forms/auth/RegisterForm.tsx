        ...
        <div className="relative m-3">
          ...
          <div className="background-light900_dark200 flex w-[300px] gap-2 rounded-xl border border-primary-500 p-5">
            <label className={selectedRole === "employee" ? "text-primary-500" : ""}>
              <input type="radio" name="role" value="employee" checked={selectedRole === "employee"}
                     onChange={handleRoleChange} className="m-2"/>
              Pracownik
            </label>
            <label className={selectedRole === "employer" ? "text-primary-500" : ""}>
              <input type="radio" name="role" value="employer" checked={selectedRole === "employer"}
                     onChange={handleRoleChange} className="m-2"/>
              Pracodawca
            </label>
          </div>
