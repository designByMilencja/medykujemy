...
const SingleProcedure = ({title, sources, src, video, description}: Props) => {
    return (
        <div className="card-wrapper mt-4 flex w-full flex-col gap-5 rounded-[10px] p-2 sm:px-11 md:items-center">
            <div className="mt-8 flex flex-col gap-2">
                ...
                <div className="h-[25vh] w-full max-w-[500px] rounded-lg bg-cover bg-center bg-no-repeat"
                     style={{backgroundImage: `url('${src}')`}}></div>
                <div
                    className="body-regular text-dark500_light700 my-1.5 max-w-[500px] flex-1 text-justify ">{ReactHtmlParser(description)}</div>
                <video controls>
