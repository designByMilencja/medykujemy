...
const CreateEditProcedure = ({type, procedureDetails}: Props,) => {
    ...
    const groupedSources = parsedProcedureDetails?.sources.map((tag: any) => tag.name);
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem className="flex w-full flex-col">
                            ...
                            <FormDescription className="body-regular mt-2.5 text-light-500">Dodaj maksymalnie dziesięć
                                źródeł na podstawie których powstała procedura</FormDescription>
                            <FormControl className="mt-3.5">
                                <>
                                    <Input
                                        disabled={type === 'edit'}
                                    ...
                                    {field.value.length > 0 && (
                                        <ul className="flex flex-col flex-end mt-2.5 gap-2.5">
