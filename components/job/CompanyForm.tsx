            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex w-full flex-col gap-10">
                    ...
                    render={({field}) => (
                        <FormItem className="flex w-full flex-col">
                            ...
                            <FormControl className="mt-3.5">
                                <Input
                                    className="no-focus paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 min-h-[56px] border"
                                    placeholder="pielęgniarka" {...field} />
                            </FormControl>
                            <FormMessage className="text-red-500"/>
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem className="flex w-full flex-col">
                            <FormLabel className="paragraph-semibold text-dark400_light800">
                                Szukana specjalizacja <span className="text-primary-500">*</span>
                            </FormLabel>
                            <FormControl className="mt-3.5">
                                <Input
                                    className="no-focus paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 min-h-[56px] border"
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem className="flex w-full flex-col">
                            ...
                            <FormDescription className="body-regular mt-2.5 text-light-500">Opisz czym będzie zajmował
                                się pracownik na tym stanowisku.</FormDescription>
                            <FormMessage className="text-red-500"/>
                        </FormItem>
                    )}
                />
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem className="flex w-full flex-col">
                            <FormLabel className="paragraph-semibold text-dark400_light800">Wymagania: <span
                            ...
                            <FormDescription className="body-regular mt-2.5 text-light-500">Wypisz jakie wymagania są
                                konieczne, a co będzie dodatkowo mile widziane.</FormDescription>
                            <FormMessage className="text-red-500"/>
                        </FormItem>
                    )}
                />
                    ...
                    render={({field}) => (
                        <FormItem className="flex w-full flex-col">
                            ...
                            <FormControl className="mt-3.5">
                                <Input
                                    className="no-focus paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 min-h-[56px] border"
                                    placeholder="Umowa o pracę" {...field} />
                            </FormControl>
                            <FormMessage className="text-red-500"/>
                        </FormItem>
                    )}
