...
import {editEmployee, editEmployer, updateUser} from "@/lib/actions/user.action";
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex w-full flex-col gap-10">
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormControl className="mt-3.5">
                <Input className="no-focus paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 min-h-[56px] border" placeholder="Warszawa" {...field} required/>
              </FormControl>
        ...
        <h2 className='paragraph-semibold text-dark400_light800'>2. Informacje o doświadczeniu zawodowym</h2>
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormControl className="mt-3.5">
                <Input className="no-focus paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 min-h-[56px] border" placeholder="Pielęgniarka" {...field} required />
              </FormControl>
              <FormMessage className="text-red-500"/>
            </FormItem>
          )}
        />
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormControl className="mt-3.5">
                <Input className="no-focus paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 min-h-[56px] border" placeholder="pielęgniarstwo chirurgiczne" {...field} required/>
              </FormControl>
              <FormMessage className="text-red-500"/>
            </FormItem>
          )}
        />
          <FormField
              ...
              render={({field}) => (
                  <FormItem className="flex w-full flex-col">
                      ...
                      <FormDescription className="body-regular mt-2.5 text-light-500">Opisz swoje dotychczasowe doświadczenie na tym stanowisku.</FormDescription>
                      <FormMessage className="text-red-500"/>
                  </FormItem>
              )}
          />
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              <FormLabel className="paragraph-semibold text-dark400_light800">Wymiar godzinowy <span className="text-primary-500">*</span></FormLabel>
              <FormControl className="mt-3.5">
                <Input className="no-focus paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 min-h-[56px] border" placeholder="pełny etat" {...field} required/>
              </FormControl>
              <FormMessage className="text-red-500"/>
            </FormItem>
          )}
        />
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormControl className="mt-3.5">
                <Input className="no-focus paragraph-regular background-light700_dark300 light-border-2 text-dark300_light700 min-h-[56px] border" placeholder="Umowa o pracę" {...field} required/>
              </FormControl>
              <FormMessage className="text-red-500"/>
            </FormItem>
          )}
                  ...
                  <FormItem className="flex w-full items-center">
                      <FormControl className="mt-3.5">
                          <div>
                              ...
                              <FormLabel className="paragraph-regular text-dark400_light800 ml-2">Oświadczam, że
                                  zgadzam się na wyświetlenie moich danych na stronie ogłoszeń</FormLabel></div>
                      </FormControl>
                      <FormMessage className="text-red-500"/>
                  </FormItem>
              )}
