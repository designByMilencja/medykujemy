...
import {createArticle, editArticle} from "@/lib/actions/articles.action";
...
const CreateEditArticle = ({type, articleDetails}: Props) => {
    ...
    const heading = type === "edit" ? "Edytuj informacje dotyczace artykułu" : "Dodaj informacje dotyczace artykułu";
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem className="flex w-full flex-col">
                            ...
                            <FormDescription className="body-regular mt-2.5 text-light-500">Dodaj maksymalnie trzy tagi
                                dotyczące artykułu, oddzielając je spacjami.</FormDescription>
                            <FormControl className="mt-3.5">
                                <>
                                    <Input
                                        disabled={type === 'edit'}
