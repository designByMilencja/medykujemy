...
const Contact = () => {
  ...
  return (
    <div className="flex w-full flex-col justify-between gap-4">
      ...
      <div className="card-wrapper mt-1 flex w-full justify-evenly gap-5 rounded-[10px] p-2 sm:px-11 md:items-center">
        ...
        <div className="flex flex-col items-center justify-center gap-1">
          <Image
            alt="icon of eye - to hide password"
            src="/assets/icons/phone-portrait-outline.svg"
            width={23}
            height={20}
          />
          <p className="body-regular text-dark500_light700 my-2 max-w-[500px] flex-1 text-justify">
      ...
      <div className="card-wrapper mt-8 flex w-full flex-col gap-5 rounded-[10px] p-2 sm:px-11">
        <h2 className="sm:h3-semibold base-semibold text-dark200_light900">
        ...
        <form onSubmit={handleSubmit} className="flex w-full flex-col gap-10">
          <input
            ...
            className="input-base body-regular background-light_dark300 w-full rounded-lg border border-primary-500 px-4 py-3 text-primary-500"
          />
          <input
            type="email"
            value={email}
          ...
          <textarea
            ...
            className="textarea-base body-regular background-light_dark300 h-[150px] w-full rounded-lg border border-primary-500 p-4 text-primary-500"
          />
          <button
            type="submit"
